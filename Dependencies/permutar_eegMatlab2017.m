%%% Funciï¿½n para permutar los Averages de cada sujeto para dos condiciones.

%%% Emi FlÃ³ Mayo 2017 CIBPsi
...
%%% OJO! No admite shuflear mÃ¡s de 2 condiciones, tengo que arreglarlo :)
...
%la salida del script preprocesa_composition allsubj_trig1 = condiciï¿½n dos palabras 
%allsubj_trig2 = condiciï¿½n una palabra, contradictorio i know ;)
OW = allsubj_trig2; 
TW = allsubj_trig1;
...
for j=1:g
    for i=1:length(OW)
        ...
        por_sujeto{1,1}=para_permutar{1,i}; %en por_sujeto en cada iteración están los promedios de las dos condiciones para un sujeto
        por_sujeto{2,1}=para_permutar{2,i};
        
        s = RandStream( 'mt19937ar','seed',sum(100*clock));
        Perm = randperm(s,length(por_sujeto));
