...
%     permutacion = permutado{numeroPerm};
    ...
    % 
    clusters_comp= clusterTiempoEspacioTT;
    
    save('clusters_comp_followUpPerm_411puntosTiempo_t20_10_005','clusters_comp')
...
save ('tclusters_comp_followUpPerm_411puntosTiempo_t20_010_005','tclusters_comp')
% save ('tclusters_5000p_followUpPermComposition_411puntosTiempo_t20_010_005','tclusters')
...
load tclusters_comp_followUpPerm_411puntosTiempo_t2
load tclusters_5000p_followUpPermComposition_411puntosTiempo_t20_010_005.mat
load clusters_comp_followUpPerm_411puntosTiempo_t15_10_005.mat
...
j=0;
for i=1:length(tclusters_comp)
    [h,p,ci,zval]=ztest(tclusters_comp(i),Media,St)
    if h==1
