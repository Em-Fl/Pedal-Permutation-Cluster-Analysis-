...
for i=1:length(allsubj_trig1)
    ...
    ListaS2W{1,i} = allsubj_trig_two_word_lista_sust{1,i}.avg([1:64],[102:512]);
    ListaS1W{1,i} = allsubj_trig_one_word_lista_sust{1,i}.avg([1:64],[102:512]);
end
...
permutado = permutar_eegMatlab2017(ListaS2W,ListaS1W,c,g,cond);
...
for numeroPerm=1:1%length(permutado)
    ...
    permutacion = DataRealListaSustantivo;
...
%     permutacion = permutado{numeroPerm};
    ...
    t = 15; %cantidad de puntos de tiempo mínimos que deben conformar un cluster
...
%     % 
    clusters_sust= clusterTiempoEspacioTT;
    
    save('clusters_sust_followUpPerm_411puntosTiempo_t15_10_005','clusters_sust')
%     
...
save ('tclusters_followUpPermSustantivo_411puntosTiempo_t15_010_005','tclusters_sust')
% save ('tclusters_5000p_followUpPermSustantivo_411puntosTiempo_t15_010_005','tclusters')
...
load tclusters_followUpPermSustantivo_411puntosTiempo_t15_010_005.mat
load tclusters_5000p_followUpPermSustantivo_411puntosTiempo_t15_010_005.mat
load clusters_sust_followUpPerm_411puntosTiempo_t15_10_005.mat
...
j=0;
for i=1:length(tclusters_sust)
    [h,p,ci,zval]=ztest(tclusters_sust(i),Media,St)
    if h==1
